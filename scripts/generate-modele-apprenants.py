...
headers = ["Prénom","Nom","Téléphone","Email","Langue","Niveau","Naissance (JJ/MM/AAAA)","Sexe",
           ...
           "Objectif","Besoin exprimé"]
widths  = [14,16,14,24,12,10,20,10,26,18,8,20,8,8,18,20,22,26,36]
...
examples = [
    ["Ahmed","Karimi","0612345678","","dari","A1","12/05/1988","homme","3 rue des Écoles","Saint-Ouen-sur-Seine","93400",REF["activities"][0],"oui","non",REF["education"][2],REF["prescribers"][0],REF["districts"][1],REF["goals"][0],"Parler aux employeurs pendant les entretiens"],
    ["Olena","Kovalenko","","olena@mail.com","ukrainien","","03/11/1995","femme","","Aubervilliers","93300",REF["activities"][1],"","",REF["education"][3],REF["prescribers"][1],"","",""],
]
