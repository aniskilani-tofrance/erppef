    ...
    lessons: [
      ...
      },
      {
        ...
        steps: [
          ...
          "Sur la fiche, renseignez « Nous a contactés par » (bouche-à-oreille, France Travail, réseaux sociaux…) : la carte « D'où viennent les demandes » et le bilan financeur montrent quels canaux amènent du monde. Dans les listes, une pastille devant le nom donne la famille de provenance d'un coup d'œil : bleu marine = maison de quartier (cours municipaux BOP104), vert = contact direct (cours PEF A1 / A2), orange = prescripteur ou partenaire, creuse = à renseigner. Elle se déduit aussi du champ Prescripteur (« MDQ Landy » suffit), et le filtre « provenances » isole une famille ou un canal.",
      ...
      },
      {
        ...
        steps: [
          ...
          "Dossier administratif (fiche → bloc dédié) : pièce d'identité recto et verso, justificatif de domicile, autres documents. Sur téléphone, « Photo / scan » ouvre l'appareil photo ; sur iPhone, « Fichier » → ⋯ → « Scanner des documents » donne un PDF redressé. Visible par la coordination seulement, supprimé avec la fiche ; le compteur « 3 / 3 pièces » dit que le dossier est complet.",
  ...
  // ───────────────────────── PARCOURS COMMERCIAL ─────────────────────────
  {
    ...
    lessons: [
      ...
      },
      {
        ...
        steps: [
          "Ce qui part sans vous : invitation à réserver un créneau dix minutes après le formulaire s'il n'a rien réservé, confirmation du créneau Calendly, rappel la veille et deux heures avant, message après un rendez-vous manqué. Chaque envoi est écrit dans le journal de la fiche, et le survol d'une ligne affiche le message complet — lisez-le avant de rappeler, le restaurateur l'a déjà reçu.",
          "Tout part dans la seconde, à toute heure : un restaurateur qui remplit le formulaire à minuit après son service reçoit son SMS aussitôt. Un même message n'est jamais envoyé deux fois à la même fiche.",
        ...
        practice: { instruction: "Ouvrez une fiche et survolez une ligne « E-mail envoyé » ou « SMS envoyé » du journal : le message exact reçu par le restaurateur s'affiche. Ouvrez ensuite le menu SMS : un seul modèle, « rappel de créneau promis ».", href: "/leads", hrefLabel: "Ouvrir les leads" },
      },
      {
        id: "rdv",
