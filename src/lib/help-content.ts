  ...
  },
  {
    ...
    articles: [
      ...
      },
      {
        ...
        steps: [
          "Un stagiaire est une fiche formateur avec le contrat « Stagiaire » (Formateurs → Nouveau formateur) : établissement et date de fin de stage, email pour son compte (rôle formateur), disponibilités, couleur sur le planning, agenda Google, documents (convention de stage, CV) dans « Qualifications ». Coût horaire : 0 ou la gratification.",
