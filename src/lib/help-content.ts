    ...
    articles: [
      {
        ...
        steps: [
          ...
          "La provenance se lit d'un coup d'œil : une pastille de couleur devant chaque nom (liste Apprenants et onglet Admission), toujours la même couleur pour le même canal (orange = bouche-à-oreille, bleu marine = France Travail, vert = WhatsApp, rose = réseaux sociaux…), le libellé sous le nom et la précision au survol. Une pastille creuse = canal non renseigné : complétez la fiche. Le filtre « Toutes les provenances » (à côté du filtre par statut) sert de légende et isole un canal, par exemple pour rappeler tous les contacts venus d'un partenaire.",
        ],
      },
      {
